...
const ELEVEN_LABS_VOICE_IDS = {
  ...
  "he/him": "goT3UYdM9bhm0n2lmKQx",
  "she/her": "g6xIsTj2HwM6VR4iXFCw",
};
...
export async function POST(request) {
  try {
    const { text, language, speakerPronouns } = await request.json();
        ...
        { error: "No text provided" },
        {
          ...
          headers: {
            "Access-Control-Allow-Origin":
              "https://anydialect.duranirving.com/",
          },
        }
      );
    }
    ...
    const voiceId =
      ELEVEN_LABS_VOICE_IDS[speakerPronouns] ||
      ELEVEN_LABS_VOICE_IDS["default"];
    ...
    return new Response(audioBuffer, {
      ...
      headers: {
        ...
        "Access-Control-Allow-Origin": "https://anydialect.duranirving.com/", // ✅ CORS header for binary response
      },
    });
  } catch (error) {
